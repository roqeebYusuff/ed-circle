...
const PopularClass = () => {
  ...
  return (
    <section className="py-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative">
      <h6 className="text-lg text-purple-500  font-medium">Explore Programs</h6>
      <h3 className="text-3xl font-semibold  py-3">Our Most Popular Class</h3>
